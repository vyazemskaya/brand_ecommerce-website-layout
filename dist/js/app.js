(() => {
    ...
    (() => {
        ...
        let offersSlider;
        let suggestionsSlider;
        function initSliders() {
            const screenWidth = window.innerWidth;
            if (screenWidth < 991.98 && void 0 == offersSlider) offersSlider = new core(".offers-mainpage__slider", {
            ...
            }); else if (screenWidth > 991.98 && void 0 != offersSlider) {
                offersSlider.navigation.destroy();
                offersSlider.destroy();
                offersSlider = void 0;
            }
            if (screenWidth < 767.98 && void 0 == suggestionsSlider) suggestionsSlider = new core(".suggestions-mainpage__slider", {
            ...
            }); else if (screenWidth > 767.98 && void 0 != suggestionsSlider) {
                suggestionsSlider.destroy();
                suggestionsSlider = void 0;
            }
        }
        initSliders();
        ...
        da.init();
        window.addEventListener("load", (function(e) {
            const submenusInit = targetEl => {
                const submenusContainer = document.querySelector(".menu__content");
                const submenuOpen = targetEl => {
                    const submenuOpenBtnId = targetEl.getAttribute("data-menu-id");
                ...
                const submenuClose = targetEl => {
                    targetEl.closest(".menu__catalog").classList.remove("_active");
                };
                if (targetEl.closest(".list-menu__item_parent")) submenuOpen(targetEl); else if (targetEl.closest(".menu__back-btn")) submenuClose(targetEl);
            };
            document.addEventListener("click", (function(e) {
                const targetEl = e.target;
                if (targetEl.closest(".menu__catalog")) submenusInit(targetEl);
            }));
        }));
        window["FLS"] = true;
        isWebp();
